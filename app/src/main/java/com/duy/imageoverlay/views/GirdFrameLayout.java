 ...
 * visual rhythm.
 */
public class GirdFrameLayout extends FrameLayout {
    ...
    public GirdFrameLayout(Context context) {
        this(context, null);
    }

    public GirdFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GirdFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setPaintWidth(int mWidth) {
        this.paintWidth = mWidth;
